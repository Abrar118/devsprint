...
const ThermoDynamicsPage = (props: Props) => {
  const courses = [
    {
      id: 1,
  ...
  const filteredCourses = courses.filter(course => course.category === 'Mechanical Engineering' && course.subcategory === 'ThermoDynamics');
  return (
    <div>
      <h1>ThermoDynamicsPage</h1>
